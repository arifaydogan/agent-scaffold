...
export function selectExecutionProfile(settings, issue, plan = {}) {
  ...
  const modelProfile =
    ...
    (provider === plan?.agentExecutor?.provider && plan?.agentExecutor?.modelProfile ? plan.agentExecutor.modelProfile : null) ||
  ...
  const model =
    ...
    (provider === plan?.agentExecutor?.provider && plan?.agentExecutor?.model ? plan.agentExecutor.model : null) ||
