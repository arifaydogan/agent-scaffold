...
export function selectReviewProfile(settings, issue, plan = null, snapshot = null) {
  ...
  return {
    provider,
    config,
    persona: snapshot?.persona || reviewPolicy?.persona || "qa-engineer",
    taskAgent: snapshot?.taskAgent || reviewPolicy?.taskAgent || reviewPolicy?.persona || "qa-engineer",
    agent: snapshot?.taskAgent || reviewPolicy?.taskAgent || reviewPolicy?.persona || "qa-engineer",
    model,
    modelProfile,
