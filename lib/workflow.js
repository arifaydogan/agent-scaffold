...
export const DEFAULT_WRITE_MAPPINGS = Object.freeze({
  jira: {
  ...
  "github-issues": {
    in_progress: { addLabel: "in-progress" },
    review: { addLabel: "in-review" },
    rework: { addLabel: "agent-rework" },
    human_approval: { addLabel: "human-approval" },
    blocked: { addLabel: "blocked" }
  }
});

export function writeMappingFor(provider, override = {}) {
  const defaults = DEFAULT_WRITE_MAPPINGS[provider] || {};
