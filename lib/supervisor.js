 ...
 * - Never merges, pushes, writes work sources, marks Done, or releases live issue locks.
 *
 ...
 * @property {object}  [workSource]             - injected WorkSourceProvider for tests
 * @property {object}  [jira]                   - legacy injected provider alias
    ...
    while (cycleCount < maxCycles) {
      ...
      try {
        cycleResult = await dispatchOnceImpl(settings, {
          ...
          workSource: injectedWorkSource || injectedJira,
          store,
