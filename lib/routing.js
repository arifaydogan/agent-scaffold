const routes = [
  {
    keywords: ["jira", "confluence", "backlog", "prd"],
    persona: "pm-analyst",
  ...
  {
    keywords: [
      "fastapi", "app factory", "dependency seam", "backend api",
      "worktree", "shared-path", "shared path", "path lock", "lock registry", "runtime", "node.js"
    ],
