...
export class JiraClient {
  ...
  async listWorkItems(query) {
    ...
    const fields = query.includeDescription === false
      ? "key,summary,issuetype,status,labels,parent,assignee"
      : "key,summary,description,issuetype,status,labels,parent,assignee";
  ...
  async getChildren(id) {
    const fields = "key,summary,description,issuetype,status,labels,parent,assignee";
