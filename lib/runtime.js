...
export function createConfigSnapshot(settings, issue, plan = {}, options = {}) {
  ...
  const reviewTaskAgent = reviewProfile?.taskAgent || plan?.reviewer || reviewProfile?.persona || "correctness-reviewer";
  ...
  return {
    ...
    reviewer: plan?.reviewer || agentRecord?.definition?.reviewer || "correctness-reviewer",
