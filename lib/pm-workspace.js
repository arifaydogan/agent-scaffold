...
export function buildPmWorkItemDetail(settings, issueKey, options = {}) {
  ...
  if (parent) {
    ...
    return {
      ...
      review: {
        reviewerTaskAgent: "correctness-reviewer",
        reviewAgentVersion: 1,
        reviewAgentHash: null,
        reviewProvider: null,
        reviewModel: null,
        reviewModelProfile: null,
        verdict: parent.completionPacket?.integrationReview?.verdict || null,
        latestImplementationSha: parent.completionPacket?.integrationHeadSha || null,
        structuredFindings: parent.completionPacket?.integrationReview?.findings || [],
        reviewCycles: []
      },
      humanControl: {
